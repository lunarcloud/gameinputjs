...
class GameInputDom {
    ...
    /**
     * Sets Up DOM for game input management
     * @param {GameInput} gi the game input manager
     */
    static setupDom(gi) {
        let commonStyleElement = document.createElement('link');
...
export default GameInputDom
export { GameInputDom, GameInput }
