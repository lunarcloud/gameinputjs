...
const GravisGamepadProSchema = new GamepadAPI(
    /* dpadUp */ new SchemaAxisButton(-2),
    /* dpadDown */ new SchemaAxisButton(2),
    /* dpadLeft */ new SchemaAxisButton(-1),
    /* dpadRight */ new SchemaAxisButton(1),
    /* menu */ 10,
    /* button0 */ 2,
    /* button1 */ 3,
    /* button2 */ 1,
    ...
    /* rightStickUp */ new SchemaAxisButton(-4),
    /* rightStickDown */ new SchemaAxisButton(4),
    /* rightStickLeft */ new SchemaAxisButton(-3),
    /* rightStickRight */ new SchemaAxisButton(3),
    /* leftShoulder */ 5,
    /* rightShoulder */ 6,
    /* leftTrigger */ 7,
    /* rightTrigger */ 8
...
const GameInputModels = [
    ...
    new GameInputModel(
        ...
        'Linux',
        new GamepadAPI(
            /* dpadUp */ new SchemaAxisButton(-6),
            /* dpadDown */ new SchemaAxisButton(6),
            /* dpadLeft */ new SchemaAxisButton(-5),
            /* dpadRight */ new SchemaAxisButton(5),
            /* menu */ 10,
            /* button0 */ 2,
            /* button1 */ 3,
            /* button2 */ 1,
            /* button3 */ 4,
            /* leftStickUp */ new SchemaAxisButton(-2),
            /* leftStickDown */ new SchemaAxisButton(2),
            /* leftStickLeft */ new SchemaAxisButton(-1),
            /* leftStickRight */ new SchemaAxisButton(1),
            /* rightStickUp */ new SchemaAxisButton(-4),
            /* rightStickDown */ new SchemaAxisButton(4),
            /* rightStickLeft */ new SchemaAxisButton(-3),
            /* rightStickRight */ new SchemaAxisButton(3),
    ...
    new GameInputModel(
        ...
        'Linux',
        new GamepadAPI(
            /* dpadUp */ new SchemaAxisButton(-8),
            /* dpadDown */ new SchemaAxisButton(8),
            /* dpadLeft */ new SchemaAxisButton(-7),
            /* dpadRight */ new SchemaAxisButton(7),
            /* menu */ 8,
            /* button0 */ 1,
            /* button1 */ 2,
            /* button2 */ 3,
            ...
            /* leftStickLeft */ new SchemaAxisButton(-1),
            /* leftStickRight */ new SchemaAxisButton(1),
            /* rightStickUp */ new SchemaAxisButton(-5),
            /* rightStickDown */ new SchemaAxisButton(5),
            /* rightStickLeft */ new SchemaAxisButton(-4),
            /* rightStickRight */ new SchemaAxisButton(4),
            /* leftShoulder */ 5,
            /* rightShoulder */ 6,
            /* leftTrigger */ new SchemaAxisButton(3),
            /* rightTrigger */ new SchemaAxisButton(6)
    )),
    new GameInputModel(
        GameInputSchema.Hedgehog,
        'generic',
    ...
    GameInputSchema.Plumber,
        ...
        'macOS',
        new GamepadAPI(
            /* dpadUp */ new SchemaAxisButton(-3),
            /* dpadDown */ new SchemaAxisButton(3),
            /* dpadLeft */ new SchemaAxisButton(-2),
            /* dpadRight */ new SchemaAxisButton(2),
            /* menu */ 10,
            /* button0 */ 2,
            /* button1 */ 3,
            /* button2 */ 1,
    ...
    new GameInputModel(
        ...
        new GamepadAPI(
            ...
            /* leftStickUp */ new SchemaAxisButton(2, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* leftStickDown */ new SchemaAxisButton(-2, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* leftStickLeft */ new SchemaAxisButton(1, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* leftStickRight */ new SchemaAxisButton(-1, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* rightStickUp */ new SchemaAxisButton(-6, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* rightStickDown */ new SchemaAxisButton(6, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* rightStickLeft */ new SchemaAxisButton(-5, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* rightStickRight */ new SchemaAxisButton(5, frenchVRStickThreshold, frenchVRStickDeadzone),
            /* leftShoulder */ 5,
            /* rightShoulder */ 6,
            /* leftTrigger */ 7,
            /* rightTrigger */ 8
